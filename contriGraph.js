...
function year_wise_plot(){
  ...
  var area = d3.svg.area()
      ...
      .y0(height1)
      .y1(function(d) { return yScale(d.no_Of_Commits); });
  ...
  d3.json("./outputJsonsNew/jsonFileForOverallCommitsForContributorsGraph1.json",function(error, data) {
   ...
   console.log(str);
    ...
    yScale.domain([0, d3.max(data, function(d) { return d.no_Of_Commits; })]);
